...
fn create_proof_fixture(
    ...
    let ComputeHyptoneusePublicParams { x, y, z } =
        ComputeHyptoneusePublicParams::abi_decode(bytes, false).unwrap();

    // Create the testing fixture so we can test things end-to-end.
    let fixture = SP1Sc05ProofFixture {
        x,
        y,
        z,
